...
class Lista extends Component {
    ...
    getContent() {
        var data = Parent.Actions.getAll(this.key_condominio, null, this.props);
        ...
        return <STable2
            header={[
                ...
                {
                    key: "key_usuario_administrador-foto", label: "Foto", width: 70, center: true, component: (key) => {
                        return <SView width={40} height={40} onPress={() => {
                        }}>
                            <SImage src={SSocket.api.root + "usuario/" + key} enablePreview/>
                        </SView>
                    }
                },
                {
                    key: "key_usuario_administrador", label: "Usuario", width: 150, center: true, render: (key) => {
