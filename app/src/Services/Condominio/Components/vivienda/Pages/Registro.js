    ...
    getContent() {
        ...
        return <SForm
            ...
            inputs={{
                ...
                nombre: { label: "numero", isRequired: true, defaultValue: this.data["nombre"] },
                mts2: { label: "mts2", type: "number", defaultValue: this.data["mts2"] },
                precio: { label: "precio", type: "number", defaultValue: this.data["precio"] },
